---
note_type: moc
title: MOC - Inverse Problems and Data Assimilation
topics:
  - SciML
...
# MOC - Inverse Problems and Data Assimilation
...
FROM ""
WHERE note_type = "paper" AND publish != false AND !contains(file.path, "_templates/") AND contains(topics, "Inverse Problems and Data Assimilation") AND (status = "reading" OR status = "queued")
...
FROM ""
WHERE note_type = "paper" AND publish != false AND !contains(file.path, "_templates/") AND contains(topics, "Inverse Problems and Data Assimilation")
